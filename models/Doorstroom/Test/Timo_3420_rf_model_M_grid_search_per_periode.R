...
fit_modellen <- function(bestandspad, periode) {
  ...
  saverds_csv(paramresults, paste0('gridsearch_results_M_', periode, "_", date),
              output = '4. Analyses/Doorstroomprognose/Data/Gridsearch/', save_csv = TRUE)
}

lPrepped_data_paden <- c(
  '4. Analyses/Doorstroomprognose/Data/Geprepareerd/M/dfAS_prepped_M_P2_20240708.rds',
  '4. Analyses/Doorstroomprognose/Data/Geprepareerd/M/dfAS_prepped_M_P3_20240708.rds',
  '4. Analyses/Doorstroomprognose/Data/Geprepareerd/M/dfAS_prepped_M_P4_20240708.rds'
)
